...
class Ticket(models.Model):
    voter = models.ForeignKey(to=User, on_delete=None, related_name=None, related_query_name=None, limit_choices_to=None, parent_link=False, to_field=None, db_constraint=True)
