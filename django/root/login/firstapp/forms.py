...
class LoginForm(forms.Form):
    username = forms.CharField(max_length=None, min_length=None, strip=True, empty_value='')
    password = forms.CharField(max_length=None, min_length=None, strip=True, empty_value='')
